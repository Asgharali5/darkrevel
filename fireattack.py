#!usr
# -*- coding: UTF-8 -*-
# mod by: Rizal_CyberEror404
# team: Mr.Cyber_Anonymous Team
...
def banner():
    ...
    print GG+"  √=================👹👹👹👹============================√"
    print WW+"  | 👉👉Mod by Rizal_Cyber404👈👈  |"
    print GL+"  |       Mr.Cyber_Anonymous Team       |"
    print WW+"  |            👹👹👹FACEBOOK:https://www.facebook.com/maz.lily.18👹👹👹            |"
    print Y+"  |             🔱🔱Whats App:088805480605🔱🔱              |"
    print GL+"  |👹👹👹👉👹👹👹👹👹👈👹👹👹👹|"
...
print ("Mr.Cyber_Anonymous Team, We make a system & breck any system")
print ("Founder-Anirban Sumon, CEO-Dark Revel, Mr-Cyber Shadow")
raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
